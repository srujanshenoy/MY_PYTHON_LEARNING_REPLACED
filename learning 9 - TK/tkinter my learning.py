...
label = tk.Label(root, text="HI!", font=('Arial', 18))
label.pack(padx=20, pady=20)
#
Textbox = tk.Text(root, height=3, font=('Arial', 16), width=20, pady=10)
Textbox.pack(padx=20)
#
# button = tk.Button(root, text="Click Me!", font=('Airal', 18))
